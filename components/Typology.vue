<template>
  <div class="relative my-8 p-2 pt-6 border-color-primary-primary border-2 rounded-xl">
    ...
    <div class="grid grid-cols-[1fr_2px_1fr] gap-x-4 text-color-primary-primary">
      <template v-for="stat in stats" :key="stat.name">
        ...
        <div class="flex items-center">
          <div class="grow-1 h-1 sm:h-2 mr-4 bg-color-primary-primary rounded-full" :style="`width: ${ stat.percent }%`" />
