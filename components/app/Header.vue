            ...
            >
              <PopoverPanel v-slot="{ close }" class="absolute left-1/2 z-10 mt-3 w-screen max-w-md -translate-x-1/2 transform px-2 sm:px-0">
                <div class="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                  <div class="bg-color-secondary text-white h-10 text-center py-2">
                    <NuxtLink to="/tableau-de-bord" class="hover:underline font-bold" @click="close()">
                      Tableau de bord 📊
                    </NuxtLink>
                  </div>
          ...
          <div class="pt-5 pb-6 px-5">
            <div class="flex items-center justify-between">
              <NuxtLink to="/" @click="close()">
                <img class="h-8 h-auto" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRmhVxxaZmo-qSqIqhnj5ZrGoX0lP1UChF4dw&s" :alt="`logo ${getAssoName()}`">
              </NuxtLink>
              <div class="-mr-2">
                <PopoverButton
                  class="bg-white rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-color-primary-primary"
