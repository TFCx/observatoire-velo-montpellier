    ...
    <div class="relative max-w-7xl mx-auto">
      ...
      <div class="mt-4">
        ...
        <div class="mt-1 relative rounded-md shadow-sm">
          ...
          <input id="compteur" v-model="searchText" type="text" class="py-4 pl-10 pr-4 text-lg shadow-md focus:ring-color-primary-primary focus:border-color-primary-primary block w-full border-gray-900 text-gray-900 rounded-md" placeholder="Chercher un compteur...">
        </div>
      </div>
