<template>
  <div class="flex-grow mx-auto max-w-7xl w-full flex flex-col px-4 sm:px-6 lg:px-8">
    <div class="flex-shrink-0 my-auto py-16 sm:py-32">
      <p class="text-sm font-semibold text-color-primary-primary uppercase tracking-wide">
        erreur 404
      </p>
      ...
      <div class="mt-6">
        <NuxtLink
          to="/"
          class="text-base font-medium text-color-primary-primary hover:underline"
        >
